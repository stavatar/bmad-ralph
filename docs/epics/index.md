...
- [bmad-ralph - Epic Breakdown](#table-of-contents)
  - [Context Validation](#context-validation)
  - [Overview](#overview)
  - [Functional Requirements Inventory](#functional-requirements-inventory)
  - [Story Sizing Guidelines (Pre-mortem)](#story-sizing-guidelines-pre-mortem)
  - [FR Coverage Map](#fr-coverage-map)
  - [Epics Structure Plan](#epics-structure-plan)
  - [Epic 1: Foundation & Project Infrastructure — Stories](#epic-1-foundation-project-infrastructure-stories)
  - [Epic 2: Story-to-Tasks Bridge — Stories](#epic-2-story-to-tasks-bridge-stories)
  - [Epic 3: Core Execution Loop — Stories](#epic-3-core-execution-loop-stories)
